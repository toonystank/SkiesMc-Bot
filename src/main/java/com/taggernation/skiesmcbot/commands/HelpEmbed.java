...
public class HelpEmbed {
    ...
    public MessageEmbed getEmbed(SlashCommandInteractionEvent event) {
        ...
        embedBuilder.setAuthor(Objects.requireNonNull(event.getMember()).getEffectiveName(), null, event.getMember().getAvatarUrl());
